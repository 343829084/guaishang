...
public class BaseFragment extends Fragment {
	...
	public void jumpToChatActivity(final String hisUserID,
			final String hisRealName,final AvatarBean headImageBean,final int chatType,final  String mobile,boolean showPrice,String topicId) {
		getBaseActivity().jumpToChatActivity(hisUserID, hisRealName, headImageBean, chatType,mobile,showPrice,topicId);
	}
