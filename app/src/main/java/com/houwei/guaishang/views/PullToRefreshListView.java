...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	class InternalListView extends ListView implements PullToRefreshEmptyViewMethodAccessor {
	...
	protected final ListView createRefreshableView(Context context, AttributeSet attrs) {
		...
		if (mode == MODE_PULL_DOWN_TO_REFRESH || mode == MODE_BOTH) {
			...
			mHeaderLoadingView = new PullToRefreshLoadingLayout(context, MODE_PULL_DOWN_TO_REFRESH, releaseLabel, pullLabel,
					refreshingLabel, a,0);
